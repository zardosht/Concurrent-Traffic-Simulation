...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    TrafficLightPhase currentTrafficLightPhase = _trafficLight.getCurrentPhase();
    if (currentTrafficLightPhase == TrafficLightPhase::red) {
        std::cout << "TrafficLight is red. Waiting for green..." << std::endl;
